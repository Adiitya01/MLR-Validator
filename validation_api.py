...
from conversion import build_validation_rows_special_case, build_validation_dataframe
...
async def convert_drug_records(request: DrugConvertRequest):
    """
    Convert drug extraction records to validation format
    ...
    try:
        ...
        # Convert using drug-specific function
